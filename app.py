# ==============================================================================
# YOUTUBE DOWNLOADER (V26 - FULLSCREEN PLAYER & GEO-BYPASS)
# ==============================================================================
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Poppins', sans-serif; }
        ...
        /* V26 FULLSCREEN AUDIO PLAYER */
        #audio-player-bar { position: fixed; top: 100vh; left: 0; width: 100%; height: 100vh; background: #0f172a; padding: 25px; display: flex; flex-direction: column; align-items: center; justify-content: center; transition: top 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275); z-index: 2000; box-shadow: 0 -10px 40px rgba(0,0,0,0.5); overflow-y: auto;}
        #audio-player-bar.active { top: 0; }
        #audio-player-bar.mini { top: auto; bottom: 0; height: 90px; flex-direction: row; border-radius: 0; padding: 10px 20px; align-items: center; justify-content: space-between; overflow:hidden;}
        ...
        #ap-cover { width: 70%; max-width: 350px; aspect-ratio: 1; border-radius: 16px; object-fit: cover; margin-bottom: 30px; box-shadow: 0 20px 50px rgba(0,0,0,0.6); transition: 0.3s; }
        ...
        /* V25/V26 Video PIP & Sandbox styling */
...
<body>
    ...
    <div class="glass-card">
        ...
        <div id="dashboard-ui">
            ...
            <button class="choice-btn btn-dash-search" onclick="switchTab('search')">🔍 YouTube Search & Player</button>
        </div>
    ...
    <div id="audio-player-bar">
        ...
        <div class="controls">
            <button class="ctrl-btn full-only" onclick="downloadCurrentSong(event)" title="Download">📥</button>
    ...
    <script>
        ...
        function downloadCurrentSong(e) {
            ...
            const realIdx = currentResults.indexOf(currentItem);
            if(realIdx !== -1) openQuality(realIdx, 'mp3');
            else openQuality(-1, 'mp3');
        }
        ...
        async function loadQueueItem() {
            ...
            audioBar.classList.remove('mini'); // Fullscreen by default
